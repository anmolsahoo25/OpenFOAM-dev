...
License
    ...
    Runge-Kutta 2nd Order Explicit Time Stepping Scheme
\*---------------------------------------------------------------------------*/

#include "Rk2DdtScheme.H"
...
template<class Type>
tmp<typename Rk2DdtScheme<Type>::fluxFieldType>
Rk2DdtScheme<Type>::fvcDdtUfCorr
(
...
template<class Type>
tmp<typename Rk2DdtScheme<Type>::fluxFieldType>
Rk2DdtScheme<Type>::fvcDdtPhiCorr
(
    const GeometricField<Type, fvPatchField, volMesh>& U,
...
template<class Type>
tmp<surfaceScalarField> Rk2DdtScheme<Type>::meshPhi
(
